...
public class PopupWindowWithAnim extends PopupWindow {
    private Context mContext;
    private float mShowAlpha = 0.7f;
    private Drawable mBackgroundDrawable;

    public PopupWindowWithAnim(Context context) {
        this.mContext = context;
        initBasePopupWindow();
    }

    public PopupWindowWithAnim(Context mContext,View contentView) {
        super(contentView);
